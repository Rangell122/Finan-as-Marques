  ...
  return (
    ...
    >
      <div className="text-center space-y-4 mb-8">
        ...
        <p className="text-slate-500 text-sm max-w-xs mx-auto">Registre uma nova entrada ou saída no seu caixa.</p>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-border/80 w-full max-w-md flex flex-col items-center">
        ...
        <p className="text-xs text-slate-400 mt-6 text-center">Clique no botão acima para abrir o formulário ou use a Inteligência Artificial na tela inicial.</p>
      </div>
    </motion.div>
  );
}
