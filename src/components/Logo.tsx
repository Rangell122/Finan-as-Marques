  ...
  return (
    <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <defs>
        ...
        <linearGradient id="gold-grad" x1="20.5" y1="25" x2="60.5" y2="73" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#F4C95D" /> {/* Gold light */}
          <stop offset="100%" stopColor="#D4A63A" /> {/* Gold premium */}
        </linearGradient>
        {/* Silver-White gradient for the M */}
        <linearGradient id="silver-grad" x1="38.5" y1="33.5" x2="79.5" y2="73" gradientUnits="userSpaceOnUse">
